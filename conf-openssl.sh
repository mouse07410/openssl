...
# For OpenSSL-1.1.0-stable
./config --debug --prefix=/opt/local --openssldir=/opt/local/etc/openssl enable-ec_nistp_64_gcc_128 enable-md2 enable-rc5 enable-weak-ssl-ciphers enable-zlib-dynamic enable-rfc3779 experimental-jpake
